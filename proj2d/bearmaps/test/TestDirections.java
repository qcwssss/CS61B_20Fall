...
public class TestDirections {
    private static final String PATHS_FILE = "data/proj2d_test_inputs/path_results.txt";
    private static final String RESULTS_FILE = "data/proj2d_test_inputs/directions_results.txt";
    private static final int NUM_TESTS = 8;
    private static final String OSM_DB_PATH = "data/proj2d_xml/berkeley-2019.osm.xml";
