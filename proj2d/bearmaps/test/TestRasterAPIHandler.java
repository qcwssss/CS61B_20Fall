...
public class TestRasterAPIHandler {
    ...
    private static final String PARAMS_FILE = "data/proj2d_test_inputs/raster_params.txt";
    private static final String RESULTS_FILE = "data/proj2d_test_inputs/raster_results.txt";
